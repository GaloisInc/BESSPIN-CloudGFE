...
module mkCSR_RegFile(CLK,
  ...
  reg [61 : 0] CASE_new_priv3631_0b1_rg_stvec_BITS_62_TO_1_0b_ETC__q1;
  reg CASE_new_priv3631_0b1_rg_stvec_BIT_0_0b11_rg_m_ETC__q2,
  ...
  wire [63 : 0] IF_IF_csr_trap_actions_nmi_THEN_0b11_ELSE_IF_c_ETC___d1294,
		...
		_theResult___fst__h15901,
		_theResult___fst__h16102,
		...
		new_csr_value__h10717,
		new_csr_value__h9989,
		v__h10030,
		v__h13636,
		v__h7794,
		v__h9151,
		...
		y__h15935,
		y__h15952,
		y_avValue_fst__h10858,
		y_avValue_fst__h10863,
		y_avValue_fst__h10868,
		y_avValue_fst__h14777,
		y_avValue_fst__h14794,
		y_avValue_snd_snd__h14867;
  wire [22 : 0] fixed_up_val_23__h11466,
		fixed_up_val_23__h12020,
		fixed_up_val_23__h13680,
		fixed_up_val_23__h15808,
		fixed_up_val_23__h7265,
		fixed_up_val_23__h7845,
		fixed_up_val_23__h9275;
  wire [5 : 0] ie_from_x__h15885,
	       ie_to_x__h13757,
	       pie_from_x__h15886,
	       pie_to_x__h13758;
  ...
  wire [1 : 0] IF_csr_mstatus_rg_mstatus_03_BITS_12_TO_11_59__ETC___d761,
	       _theResult____h17498,
	       _theResult____h17710,
	       _theResult____h17922,
	       _theResult____h18134,
	       _theResult____h18346,
	       _theResult____h18558,
	       _theResult____h18770,
	       _theResult____h18982,
	       _theResult____h19194,
	       _theResult___fst__h13769,
	       new_priv__h13631,
	       to_y__h16101;
  wire NOT_access_permitted_1_csr_addr_ULT_0xC03_517__ETC___d1617,
       ...
       deleg_bit___1__h13778,
       deleg_bit___1__h13793,
  ...
  assign mv_update_mstatus_fs =
	     { sd__h11465, 40'd5120, fixed_up_val_23__h11466 } ;
  ...
  assign csr_trap_actions =
	     { x__h12608, x__h15745, x__h15746, new_priv__h13631 } ;
  ...
  assign csr_ret_actions =
		 ...
		 _theResult___fst__h15901 } :
	       { rg_sepc, to_y__h16101, _theResult___fst__h16102 } ;
  ...
  assign MUX_rg_mcause$write_1__SEL_2 =
	     EN_csr_trap_actions &&
	     (csr_trap_actions_nmi || new_priv__h13631 == 2'b11) ;
  ...
  assign MUX_csr_mstatus_rg_mstatus$write_1__VAL_2 =
	     { sd__h15807, 40'd5120, fixed_up_val_23__h15808 } ;
  assign MUX_csr_mstatus_rg_mstatus$write_1__VAL_4 =
	     { sd__h12019, 40'd5120, fixed_up_val_23__h12020 } ;
  ...
  begin
    case (mav_csr_write_csr_addr)
	  ...
	  MUX_csr_mstatus_rg_mstatus$write_1__VAL_5 = wordxl1__h7224;
  ...
  case (1'b1)
    ...
    EN_csr_trap_actions: csr_mstatus_rg_mstatus$D_IN = v__h13636;
    EN_ma_update_mstatus_fs:
	csr_mstatus_rg_mstatus$D_IN =
	    MUX_csr_mstatus_rg_mstatus$write_1__VAL_4;
  ...
  assign rg_tdata1$D_IN =
	     MUX_rg_tdata1$write_1__SEL_1 ? new_csr_value__h10717 : 64'd0 ;
  assign rg_tdata1$EN =
	     EN_mav_csr_write &&
	     mav_csr_write_csr_addr_ULT_0xB03_34_OR_NOT_mav_ETC___d864 ||
	     WILL_FIRE_RL_rl_reset_start ;
  ...
  assign NOT_csr_trap_actions_nmi_311_AND_csr_trap_acti_ETC___d1421 =
	     !csr_trap_actions_nmi && csr_trap_actions_interrupt &&
	     exc_code__h15587 != 4'd0 &&
	     exc_code__h15587 != 4'd1 &&
	     exc_code__h15587 != 4'd2 &&
	     exc_code__h15587 != 4'd3 &&
	     exc_code__h15587 != 4'd4 &&
	     exc_code__h15587 != 4'd5 &&
	     exc_code__h15587 != 4'd6 &&
	     exc_code__h15587 != 4'd7 &&
	     exc_code__h15587 != 4'd8 &&
	     exc_code__h15587 != 4'd9 &&
	     exc_code__h15587 != 4'd10 &&
	     exc_code__h15587 != 4'd11 ;
  assign _theResult____h17498 = rg_mideleg[11] ? 2'b01 : 2'b11 ;
  assign _theResult____h17710 = rg_mideleg[3] ? 2'b01 : 2'b11 ;
  assign _theResult____h17922 = rg_mideleg[7] ? 2'b01 : 2'b11 ;
  assign _theResult____h18134 = rg_mideleg[9] ? 2'b01 : 2'b11 ;
  assign _theResult____h18346 = rg_mideleg[1] ? 2'b01 : 2'b11 ;
  assign _theResult____h18558 = rg_mideleg[5] ? 2'b01 : 2'b11 ;
  assign _theResult____h18770 = rg_mideleg[8] ? 2'b01 : 2'b11 ;
  assign _theResult____h18982 = rg_mideleg[0] ? 2'b01 : 2'b11 ;
  assign _theResult____h19194 = rg_mideleg[4] ? 2'b01 : 2'b11 ;
  assign _theResult___fst__h13769 =
	     (csr_trap_actions_interrupt ?
		deleg_bit___1__h13778 :
		deleg_bit___1__h13793) ?
	       2'b01 :
	       2'b11 ;
  assign _theResult___fst__h15901 =
  ...
  assign _theResult___fst__h16102 =
  ...
  assign b__h13856 = csr_mstatus_rg_mstatus[ie_to_x__h13757] ;
  assign b__h15938 = csr_mstatus_rg_mstatus[pie_from_x__h15886] ;
  ...
  assign csr_trap_actions_nmi_OR_NOT_csr_trap_actions_i_ETC___d1472 =
	     ...
	     exc_code__h15587 != 4'd9 &&
	     exc_code__h15587 != 4'd11 &&
	     exc_code__h15587 != 4'd12 &&
	     exc_code__h15587 != 4'd13 &&
	     exc_code__h15587 != 4'd15 ;
  assign deleg_bit___1__h13778 = rg_mideleg[csr_trap_actions_exc_code] ;
  assign deleg_bit___1__h13793 = rg_medeleg[csr_trap_actions_exc_code] ;
  assign exc_code__h15587 =
	     csr_trap_actions_nmi ? 4'd0 : csr_trap_actions_exc_code ;
  assign exc_pc___1__h14894 = exc_pc__h14820 + vector_offset__h14821 ;
  assign exc_pc__h14820 =
	     csr_trap_actions_nmi ?
	       rg_nmi_vector :
	       y_avValue_snd_snd__h14867 ;
  assign fixed_up_val_23__h11466 =
	     { csr_mstatus_rg_mstatus[22:17],
	       ...
	       1'd0 } ;
  assign fixed_up_val_23__h12020 =
	     { csr_mstatus_rg_mstatus[22:17],
	       2'd0,
	       ma_update_mstatus_fs_fs,
	       IF_csr_mstatus_rg_mstatus_03_BITS_12_TO_11_59__ETC___d761,
	       ...
	       csr_mstatus_rg_mstatus[3:1],
	       1'd0 } ;
  assign fixed_up_val_23__h13680 =
		...
		2'b10) ?
		 ...
		 IF_IF_csr_trap_actions_nmi_THEN_0b11_ELSE_IF_c_ETC___d1294[12:11],
	       ...
	       1'd0 } ;
  assign fixed_up_val_23__h15808 =
  ...
  assign fixed_up_val_23__h9275 =
		 ...
		 mav_csr_write_word[12:11],
	       ...
	       1'd0 } ;
  assign ie_from_x__h15885 = { 4'd0, csr_ret_actions_from_priv } ;
  assign ie_to_x__h13757 = { 4'd0, new_priv__h13631 } ;
  assign interrupt_pending_cur_priv_EQ_IF_rg_mideleg_34_ETC___d1753 =
	     interrupt_pending_cur_priv == _theResult____h17498 ;
  assign interrupt_pending_cur_priv_EQ_IF_rg_mideleg_34_ETC___d1771 =
	     interrupt_pending_cur_priv == _theResult____h17710 ;
  assign interrupt_pending_cur_priv_EQ_IF_rg_mideleg_34_ETC___d1782 =
	     interrupt_pending_cur_priv == _theResult____h17922 ;
  assign interrupt_pending_cur_priv_EQ_IF_rg_mideleg_34_ETC___d1793 =
	     interrupt_pending_cur_priv == _theResult____h18134 ;
  ...
  assign interrupt_pending_cur_priv_ULT_IF_rg_mideleg_3_ETC___d1836 =
	     interrupt_pending_cur_priv < _theResult____h18982 ;
  assign mask__h13840 = 64'd1 << ie_to_x__h13757 ;
  assign mask__h13857 = 64'd1 << pie_to_x__h13758 ;
  assign mask__h15922 = 64'd1 << pie_from_x__h15886 ;
  assign mask__h15939 = 64'd1 << ie_from_x__h15885 ;
  ...
  assign mav_csr_write_word_BITS_14_TO_13_68_EQ_0x3_69__ETC___d799 =
		 ...
		 fixed_up_val_23__h7845 :
		 fixed_up_val_23__h9275 } ;
  assign new_csr_value__h10717 = { 4'd0, mav_csr_write_word[59:0] } ;
  assign new_csr_value__h9989 = { mav_csr_write_word[63:1], 1'd0 } ;
  assign new_priv__h13631 =
	     csr_trap_actions_nmi ?
	       2'b11 :
	       ((csr_trap_actions_from_priv == 2'b11) ?
		  csr_trap_actions_from_priv :
		  _theResult___fst__h13769) ;
  assign pie_from_x__h15886 = { 4'd1, csr_ret_actions_from_priv } ;
  assign pie_to_x__h13758 = { 4'd1, new_priv__h13631 } ;
  assign sd__h11465 = mv_update_mstatus_fs_fs == 2'h3 ;
  assign sd__h12019 = ma_update_mstatus_fs_fs == 2'h3 ;
  assign sd__h13679 =
	     IF_IF_csr_trap_actions_nmi_THEN_0b11_ELSE_IF_c_ETC___d1294[14:13] ==
	     2'h3 ;
  assign sd__h15807 =
  ...
  assign v__h9151 =
	     { 48'd0,
	       ...
	       2'd0,
	       mav_csr_write_word[9:0] } ;
  assign v__h9187 = { 52'd0, mav_csr_write_word[11:0] } ;
  assign v__h9797 =
	     { mav_csr_write_word[63:2], 1'b0, mav_csr_write_word[0] } ;
  assign val__h13841 = 64'd0 << ie_to_x__h13757 ;
  assign val__h13858 = { 63'd0, b__h13856 } << pie_to_x__h13758 ;
  assign val__h15940 = { 63'd0, b__h15938 } << ie_from_x__h15885 ;
  assign vector_offset__h14821 = { 58'd0, csr_trap_actions_exc_code, 2'd0 } ;
  assign wordxl1__h7224 = { 41'h10000001400, fixed_up_val_23__h7265 } ;
  assign wordxl1__h9234 = { sd__h9274, 40'd5120, fixed_up_val_23__h9275 } ;
  assign x__h12608 =
	     csr_trap_actions_interrupt_AND_NOT_csr_trap_ac_ETC___d1320 ?
	       exc_pc___1__h14894 :
	       exc_pc__h14820 ;
  assign x__h13839 = x__h13869 | val__h13858 ;
  assign x__h13852 = x__h13839 & y__h13853 ;
  assign x__h13869 = csr_mstatus_rg_mstatus & y__h13870 ;
  assign x__h15745 =
	     (csr_trap_actions_nmi || new_priv__h13631 == 2'b11) ?
	       v__h13636 :
	       y_avValue_fst__h14794 ;
  assign x__h15746 =
	     { !csr_trap_actions_nmi && csr_trap_actions_interrupt,
	       59'd0,
	       exc_code__h15587 } ;
  assign x__h15921 = x__h15951 | val__h15940 ;
  assign x__h15934 = x__h15921 & y__h15935 ;
  assign x__h15951 = csr_mstatus_rg_mstatus & y__h15952 ;
  assign x__h5628 =
	     (!mav_csr_write_csr_addr_ULT_0xB03___d734 &&
	      mav_csr_write_csr_addr_ULE_0xB1F___d735 ||
	      !mav_csr_write_csr_addr_ULT_0x323___d738 &&
	      mav_csr_write_csr_addr_ULE_0x33F___d739) ?
	       64'd0 :
	       y_avValue_fst__h11098 ;
  assign y__h13853 = ~mask__h13840 ;
  assign y__h13870 = ~mask__h13857 ;
  assign y__h15935 = ~mask__h15922 ;
  assign y__h15952 = ~mask__h15939 ;
  assign y_avValue_fst__h10858 = { 59'd0, mav_csr_write_word[4:0] } ;
  assign y_avValue_fst__h10863 = { 61'd0, mav_csr_write_word[2:0] } ;
  assign y_avValue_fst__h10868 = { 56'd0, mav_csr_write_word[7:0] } ;
  assign y_avValue_fst__h14777 =
	     { sd__h13679,
	       43'd8192,
	       ...
	       1'd0 } ;
  assign y_avValue_fst__h14794 =
	     (new_priv__h13631 == 2'b01) ? y_avValue_fst__h14777 : v__h13636 ;
  assign y_avValue_snd_snd__h14867 =
	     { CASE_new_priv3631_0b1_rg_stvec_BITS_62_TO_1_0b_ETC__q1,
	       2'd0 } ;
  always@(mav_csr_write_csr_addr or
	  mav_csr_write_word or
	  y_avValue_fst__h10858 or
	  y_avValue_fst__h10863 or
	  y_avValue_fst__h10868 or
	  v__h7794 or
	  csr_mie$mav_sie_write or
	  v__h9797 or
	  new_csr_value__h9989 or
	  v__h10030 or
	  csr_mip$mav_sip_write or
	  wordxl1__h9234 or
	  v__h9151 or
	  v__h9187 or
	  csr_mie$mav_write or csr_mip$mav_write or new_csr_value__h10717)
  begin
    case (mav_csr_write_csr_addr)
      12'h001: y_avValue_fst__h11098 = y_avValue_fst__h10858;
      12'h002, 12'h306: y_avValue_fst__h11098 = y_avValue_fst__h10863;
      12'h003: y_avValue_fst__h11098 = y_avValue_fst__h10868;
      12'h100: y_avValue_fst__h11098 = v__h7794;
      12'h102, 12'h103, 12'h106, 12'h7A0, 12'hF11, 12'hF12, 12'hF13, 12'hF14:
	  y_avValue_fst__h11098 = 64'd0;
      12'h104: y_avValue_fst__h11098 = csr_mie$mav_sie_write;
      12'h105, 12'h305: y_avValue_fst__h11098 = v__h9797;
      12'h140, 12'h143, 12'h180, 12'h340, 12'h343, 12'hB00, 12'hB02:
	  y_avValue_fst__h11098 = mav_csr_write_word;
      12'h141, 12'h341: y_avValue_fst__h11098 = new_csr_value__h9989;
      12'h142, 12'h342: y_avValue_fst__h11098 = v__h10030;
      12'h144: y_avValue_fst__h11098 = csr_mip$mav_sip_write;
      12'h300: y_avValue_fst__h11098 = wordxl1__h9234;
      12'h301: y_avValue_fst__h11098 = 64'h800000000014112D;
      12'h302: y_avValue_fst__h11098 = v__h9151;
      12'h303: y_avValue_fst__h11098 = v__h9187;
      12'h304: y_avValue_fst__h11098 = csr_mie$mav_write;
      12'h344: y_avValue_fst__h11098 = csr_mip$mav_write;
      12'h7A1: y_avValue_fst__h11098 = new_csr_value__h10717;
      default: y_avValue_fst__h11098 = mav_csr_write_word;
    endcase
  end
  always@(new_priv__h13631 or rg_mtvec or rg_stvec)
  begin
    case (new_priv__h13631)
      2'b01:
	  CASE_new_priv3631_0b1_rg_stvec_BITS_62_TO_1_0b_ETC__q1 =
	      rg_stvec[62:1];
      2'b11:
	  CASE_new_priv3631_0b1_rg_stvec_BITS_62_TO_1_0b_ETC__q1 =
	      rg_mtvec[62:1];
      default: CASE_new_priv3631_0b1_rg_stvec_BITS_62_TO_1_0b_ETC__q1 =
		   rg_mtvec[62:1];
    endcase
  end
  always@(new_priv__h13631 or rg_mtvec or rg_stvec)
  begin
    case (new_priv__h13631)
	  ...
	  CASE_new_priv3631_0b1_rg_stvec_BIT_0_0b11_rg_m_ETC__q2 =
	      rg_mtvec[0];
      default: CASE_new_priv3631_0b1_rg_stvec_BIT_0_0b11_rg_m_ETC__q2 =
		   rg_mtvec[0];
    endcase
  end
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write("    Return: new pc 0x%0h  ", x__h12608);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write(" new mstatus:");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$write("MStatus{",
	       "sd:%0d",
	       x__h15745[14:13] == 2'h3 || x__h15745[16:15] == 2'h3);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write(" sxl:%0d uxl:%0d", x__h15745[35:34], x__h15745[33:32]);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write(" tsr:%0d", x__h15745[22]);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write(" tw:%0d", x__h15745[21]);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write(" tvm:%0d", x__h15745[20]);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write(" mxr:%0d", x__h15745[19]);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write(" sum:%0d", x__h15745[18]);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write(" mprv:%0d", x__h15745[17]);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write(" xs:%0d", x__h15745[16:15]);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write(" fs:%0d", x__h15745[14:13]);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write(" mpp:%0d", x__h15745[12:11]);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write(" spp:%0d", x__h15745[8]);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write(" pies:%0d_%0d%0d", x__h15745[7], x__h15745[5], x__h15745[4]);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write(" ies:%0d_%0d%0d", x__h15745[3], x__h15745[1], x__h15745[0]);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write("}");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955 &&
	  NOT_csr_trap_actions_nmi_311_AND_csr_trap_acti_ETC___d1421)
	$write("unknown interrupt Exc_Code %d", exc_code__h15587);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955 &&
	  (csr_trap_actions_nmi || !csr_trap_actions_interrupt) &&
	  exc_code__h15587 == 4'd0)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955 &&
	  csr_trap_actions_nmi_OR_NOT_csr_trap_actions_i_ETC___d1472)
	$write("unknown trap Exc_Code %d", exc_code__h15587);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$write(" new priv %0d", new_priv__h13631);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__53_ULE_1_54___d955)
	$display("");
    if (RST_N != `BSV_RESET_VALUE)
