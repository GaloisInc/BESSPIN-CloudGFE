...
// m_aws_host_access_addr_base    O    64 const
// m_aws_host_access_addr_size    O    64 const
// m_aws_host_access_addr_lim     O    64 const
...
module mkSoC_Map(CLK,
  ...
  // value method m_aws_host_access_addr_base
  output [63 : 0] m_aws_host_access_addr_base;

  // value method m_aws_host_access_addr_size
  output [63 : 0] m_aws_host_access_addr_size;

  // value method m_aws_host_access_addr_lim
  output [63 : 0] m_aws_host_access_addr_lim;
  ...
  wire [63 : 0] m_aws_host_access_addr_base,
		m_aws_host_access_addr_lim,
		m_aws_host_access_addr_size,
		m_boot_rom_addr_base,
		m_boot_rom_addr_lim,
  ...
  // value method m_aws_host_access_addr_base
  assign m_aws_host_access_addr_base = 64'h00000000C0001000 ;

  // value method m_aws_host_access_addr_size
  assign m_aws_host_access_addr_size = 64'h0000000000000080 ;

  // value method m_aws_host_access_addr_lim
  assign m_aws_host_access_addr_lim = 64'h00000000C0001080 ;
  ...
  assign m_is_IO_addr =
	     ...
	     m_is_IO_addr_addr >= 64'h00000000C0001000 &&
	     m_is_IO_addr_addr < 64'h00000000C0001080 ;
