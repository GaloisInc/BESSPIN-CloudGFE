...
module mkAWS_SoC_Top(CLK,
  ...
  begin
    ...
    v__h12767 = v__h12773 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_start_initial)
	$display("%0d: AWS_SoC_Top.rl_reset_start_initial ...", v__h12767);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h13013 = v__h13019 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete_initial)
	$display("%0d: AWS_SoC_Top.rl_reset_complete_initial", v__h13013);
  end
  // synopsys translate_on
