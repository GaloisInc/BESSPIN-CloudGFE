...
// to_slave_wdata                 O   512 reg
// to_slave_wstrb                 O    64 reg
...
// from_master_wdata              I   512 reg
// from_master_wstrb              I    64 reg
...
module mkAXI4_Deburster_DDR4(CLK,
			     RST_N,
  ...
  input  [511 : 0] from_master_wdata;
  input  [63 : 0] from_master_wstrb;
  ...
  output [511 : 0] from_master_rdata;
  ...
  output [511 : 0] to_slave_wdata;

  // value method to_slave_m_wstrb
  output [63 : 0] to_slave_wstrb;
  ...
  wire [511 : 0] from_master_rdata, to_slave_wdata;
  wire [63 : 0] to_slave_araddr, to_slave_awaddr, to_slave_wstrb;
  wire [15 : 0] from_master_bid,
		from_master_rid,
		to_slave_arid,
		to_slave_awid;
  wire [7 : 0] to_slave_arlen, to_slave_awlen;
  ...
  wire [530 : 0] m_xactor_from_master_f_rd_data$D_IN,
  ...
  wire [576 : 0] m_xactor_from_master_f_wr_data$D_IN,
  ...
  wire [530 : 0] m_xactor_to_slave_f_rd_data$D_IN,
  ...
  wire [576 : 0] m_xactor_to_slave_f_wr_data$D_IN,
  ...
  // value method from_master_m_rid
  assign from_master_rid = m_xactor_from_master_f_rd_data$D_OUT[530:515] ;

  // value method from_master_m_rdata
  assign from_master_rdata = m_xactor_from_master_f_rd_data$D_OUT[514:3] ;
  ...
  // value method to_slave_m_wdata
  assign to_slave_wdata = m_xactor_to_slave_f_wr_data$D_OUT[576:65] ;

  // value method to_slave_m_wstrb
  assign to_slave_wstrb = m_xactor_to_slave_f_wr_data$D_OUT[64:1] ;
  ...
  assign m_xactor_from_master_f_rd_data$D_IN =
	     { m_xactor_to_slave_f_rd_data$D_OUT[530:1],
	       !m_rg_r_beat_count_21_ULT_m_f_r_arlen_first__22___d123 } ;
  ...
  assign m_xactor_to_slave_f_wr_data$D_IN =
	     { m_xactor_from_master_f_wr_data$D_OUT[576:1], 1'd1 } ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  !m_rg_w_beat_count_ULT_m_xactor_from_master_f_w_ETC___d44 &&
	  !m_xactor_from_master_f_wr_data$D_OUT[0])
	$write("'h%h", m_xactor_from_master_f_wr_data$D_OUT[576:65]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_m_rl_wr_xaction_master_to_slave &&
	  !m_rg_w_beat_count_ULT_m_xactor_from_master_f_w_ETC___d44 &&
	  !m_xactor_from_master_f_wr_data$D_OUT[0])
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  !m_rg_w_beat_count_ULT_m_xactor_from_master_f_w_ETC___d44 &&
	  !m_xactor_from_master_f_wr_data$D_OUT[0])
	$write("'h%h", m_xactor_from_master_f_wr_data$D_OUT[64:1]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_m_rl_wr_xaction_master_to_slave &&
	  !m_rg_w_beat_count_ULT_m_xactor_from_master_f_w_ETC___d44 &&
	  !m_xactor_from_master_f_wr_data$D_OUT[0])
  ...
  // synopsys translate_on
endmodule  // mkAXI4_Deburster_DDR4
