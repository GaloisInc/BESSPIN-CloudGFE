...
// This program performs a series of AXI4 reads and writes to test
// host-side memory access in AWSteria_RISCV_Virtio.

// This code originated as AWSteria_Infra/TestApp/Host/main.c
...
#define    plic_addr_base             0x0C000000llu
#define    plic_addr_size             0x0C400000llu

#define    host_access_addr_base      0x40000000llu
#define    host_access_addr_size      0x40004000llu

#define    flash_mem_addr_base        0x50000000llu
#define    flash_mem_addr_size        0x58000000llu

#define    ethernet_0_addr_base       0x62100000llu
#define    ethernet_0_addr_size       0x62140000llu

#define    dma_0_addr_base            0x62200000llu
#define    dma_0_addr_size            0x62210000llu

#define    uart16550_0_addr_base      0x62300000llu
#define    uart16550_0_addr_size      0x62301000llu

#define    gpio_0_addr_base           0x6FFF0000llu
#define    gpio_0_addr_size           0x70000000llu

#define    boot_rom_base              0x70000000llu
#define    boot_rom_lim               0x70001000llu

#define    ddr4_0_uncached_addr_base  0x80000000llu
#define    ddr4_0_uncached_addr_lim   0xC0000000llu

#define    ddr4_0_cached_addr_base    0xC0000000llu
#define    ddr4_0_cached_addr_size   0x100000000llu
...
int main (int argc, char *argv [])
{
    ...
    // ----------------
    test60 (0x2000, 0xbffff000);
    // test60 (0x4, ddr4_0_uncached_addr_base);
    // test60 (0x8, ddr4_0_cached_addr_base);
